...
struct NetworkingServices {
    ...
    func fetchCategoryDishes(categoryId: String, completion: @escaping(Result<[DishPopuler], Error>) -> Void) {
...
//    gelen veriyi işledik
    ...
    private func createRequest(route: Route,
        ...
        guard let url = urlString.myUrl else { return nil }
